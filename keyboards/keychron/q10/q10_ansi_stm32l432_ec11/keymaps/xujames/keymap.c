...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_ansi_89(
        ...
        UCX_MAINS_VOLD, KC_LCTL,  KC_LOPT,            KC_LCMD,  KC_SPC,  MO(MAC_FN),                     KC_SPC,             KC_RCMD,                      KC_LEFT,  KC_DOWN,  KC_RGHT),
    ...
    [MAC_FN] = LAYOUT_ansi_89(
        ...
        _______,  _______,  RGB_RMOD, RGB_VAD,  KC_DFU,   RGB_SAD,  RGB_SPD,   _______,  _______,  _______,  _______,  _______,  _______,            _______,            _______,
    ...
    [DVORAK_BASE] = LAYOUT_ansi_89(         // WIN key switch
        ...
        UCX_MAINS_VOLD, KC_LCTL,  KC_LCMD,            KC_LALT,  KC_SPC,  MO(DVORAK_FN),                     KC_SPC,             KC_RALT,                   KC_LEFT,  KC_DOWN,  KC_RGHT),
